...
class database_vanilla526 {
	...
	public function setVanilla526Footer($id, $company_name) {
		$this->connect();
		if (is_null($id)) {
			$result = $this->db->query("INSERT INTO vanilla526 (CompanyName) VALUES ('$company_name')");
		} else {
			$result = $this->db->query("UPDATE vanilla526 SET CompanyName = '$company_name' WHERE id = '$id'");
		}
	}

	public function setVanilla526Carousel($id, $carousel_img1, $carousel_text1, $carousel_sub1, $carousel_img2, $carousel_text2, $carousel_sub2, $carousel_img3, $carousel_text3, $carousel_sub3, $carousel_img4, $carousel_text4, $carousel_sub4, $carousel_img5, $carousel_text5, $carousel_sub5, $carousel_img6, $carousel_text6, $carousel_sub6, $carousel_img7, $carousel_text7, $carousel_sub7, $carousel_img8, $carousel_text8, $carousel_sub8) {
		$this->connect();
		if (is_null($id)) {
			$result = $this->db->query("INSERT INTO vanilla526 (CarouselImg1, CarouselText1, CarouselSub1, CarouselImg2, CarouselText2, CarouselSub2, CarouselImg3, CarouselText3, CarouselSub3, CarouselImg4, CarouselText4, CarouselSub4, CarouselImg5, CarouselText5, CarouselSub5, CarouselImg6, CarouselText6, CarouselSub6, CarouselImg7, CarouselText7, CarouselSub7, CarouselImg8, CarouselText8, CarouselSub8) VALUES ('$carousel_img1', '$carousel_text1', '$carousel_sub1', '$carousel_img2', '$carousel_text2', '$carousel_sub2', '$carousel_img3', '$carousel_text3', '$carousel_sub3', '$carousel_img4', '$carousel_text4', '$carousel_sub4', '$carousel_img5', '$carousel_text5', '$carousel_sub5', '$carousel_img6', '$carousel_text6', '$carousel_sub6', '$carousel_img7', '$carousel_text7', '$carousel_sub7', '$carousel_img8', '$carousel_text8', '$carousel_sub8')");
		} else {
			$result = $this->db->query("UPDATE vanilla526 SET CarouselImg1 = '$carousel_img1', CarouselText1 = '$carousel_text1', CarouselSub1 = '$carousel_sub1', CarouselImg2 = '$carousel_img2', CarouselText2 = '$carousel_text2', CarouselSub2 = '$carousel_sub2', CarouselImg3 = '$carousel_img3', CarouselText3 = '$carousel_text3', CarouselSub3 = '$carousel_sub3', CarouselImg4 = '$carousel_img4', CarouselText4 = '$carousel_text4', CarouselSub4 = '$carousel_sub4', CarouselImg5 = '$carousel_img5', CarouselText5 = '$carousel_text5', CarouselSub5 = '$carousel_sub5', CarouselImg6 = '$carousel_img6', CarouselText6 = '$carousel_text6', CarouselSub6 = '$carousel_sub6', CarouselImg7 = '$carousel_img7', CarouselText7 = '$carousel_text7', CarouselSub7 = '$carousel_sub7', CarouselImg8 = '$carousel_img8', CarouselText8 = '$carousel_text8', CarouselSub8 = '$carousel_sub8' WHERE id = '$id'");
		}
	}

	public function setVanilla526PaginaElementen($id, $p2_header, $p2_header_text, $p2_header_list_item1, $p2_header_list_item2, $p2_header_list_item3, $p2_header_list_item4, $p2_header_cta_btn, $p2_box_title1, $p2_box_text1, $p2_box_title2, $p2_box_text2, $p2_box_title3, $p2_box_text3, $p2_box_title4, $p2_box_text4, $tab_img1, $tab_text1, $tab_img2, $tab_text2, $tab_img3, $tab_text3, $tab_img4, $tab_text4, $tab_item1, $tab_item2, $tab_item3, $tab_item4) {
		$this->connect();
		if (is_null($id)) {
			$result = $this->db->query("INSERT INTO vanilla526 (P2Header, P2HeaderText, P2HeaderListItem1, P2HeaderListItem2, P2HeaderListItem3, P2HeaderListItem4, P2HeaderCtaBtn, P2BoxTitle1, P2BoxText1, P2BoxTitle2, P2BoxText2, P2BoxTitle3, P2BoxText3, P2BoxTitle4, P2BoxText4, TabImg1, TabText1, TabImg2, TabText2, TabImg3, TabText3, TabImg4, TabText4, TabItem1, TabItem2, TabItem3, TabItem4) VALUES ('$p2_header', '$p2_header_text', '$p2_header_list_item1', '$p2_header_list_item2', '$p2_header_list_item3', '$p2_header_list_item4', '$p2_header_cta_btn', '$p2_box_title1', '$p2_box_text1', '$p2_box_title2', '$p2_box_text2', '$p2_box_title3', '$p2_box_text3', '$p2_box_title4', '$p2_box_text4', '$tab_img1', '$tab_text1', '$tab_img2', '$tab_text2', '$tab_img3', '$tab_text3', '$tab_img4', '$tab_text4', '$tab_item1', '$tab_item2', '$tab_item3', '$tab_item4')");
		} else {
			$result = $this->db->query("UPDATE vanilla526 SET P2Header = '$p2_header', P2HeaderText = '$p2_header_text', P2HeaderListItem1 = '$p2_header_list_item1', P2HeaderListItem2 = '$p2_header_list_item2', P2HeaderListItem3 = '$p2_header_list_item3', P2HeaderListItem4 = '$p2_header_list_item4', P2HeaderCtaBtn = '$p2_header_cta_btn', P2BoxTitle1 = '$p2_box_title1', P2BoxText1 = '$p2_box_text1', P2BoxTitle2 = '$p2_box_title2', P2BoxText2 = '$p2_box_text2', P2BoxTitle3 = '$p2_box_title3', P2BoxText3 = '$p2_box_text3', P2BoxTitle4 = '$p2_box_title4', P2BoxText4 = '$p2_box_text4', TabImg1 = '$tab_img1', TabText1 = '$tab_text1', TabImg2 = '$tab_img2', TabText2 = '$tab_text2', TabImg3 = '$tab_img3', TabText3 = '$tab_text3', TabImg4 = '$tab_img4', TabText4 = '$tab_text4', TabItem1 = '$tab_item1', TabItem2 = '$tab_item2', TabItem3 = '$tab_item3', TabItem4 = '$tab_item4' WHERE id = '$id'");
		}
	}

	public function setVanilla526Typo($id) {
		$this->connect();
		if (is_null($id)) {

								...
								<div id="flush-collapse4" class="accordion-collapse collapse" aria-labelledby="flush-heading4" data-bs-parent="#accordionFlushExample">
									<div class="accordion-body">
										...
										<div class="mb-3">
											...
											<input onmouseenter="showStrongSubHeadline()" onmouseleave="delStrongSubHeadline()" type="text" class="form-control" id="StrongSubHeadline" name="StrongSubHeadline" aria-describedby="StrongSubHeadlineHelp" value="<?php echo $templateData->getStrongSubHeadline(); ?>" placeholder="<?php echo $templateData->getStrongSubHeadline(); ?>">
										...
										<div class="mb-3">
											...
											<input onmouseenter="showHeaderCtaBtn()" onmouseleave="delHeaderCtaBtn()" type="text" class="form-control" id="HeaderCtaBtn" name="HeaderCtaBtn" aria-describedby="HeaderCtaBtnHelp" value="<?php echo $templateData->getHeaderCtaBtn(); ?>" placeholder="<?php echo $templateData->getHeaderCtaBtn(); ?>">

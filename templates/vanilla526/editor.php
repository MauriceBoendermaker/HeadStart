								...
								<div id="flush-collapse4" class="accordion-collapse collapse" aria-labelledby="flush-heading4" data-bs-parent="#accordionFlushExample">
									<div class="accordion-body">
										<div class="mb-3">
											...
											<input onmouseenter="myFunction()" onmouseleave="myFunction1()" type="text" class="form-control" id="Headline" name="Headline" aria-describedby="HeadlineHelp" value="<?php echo $templateData->getHeadline(); ?>" placeholder="<?php echo $templateData->getHeadline(); ?>">
